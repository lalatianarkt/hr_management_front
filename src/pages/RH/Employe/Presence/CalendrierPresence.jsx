...
const CalendrierPresence = () => {
  ...
  const [employees] = useState([
    { id: 1, nom: 'Dupont Jean', departement: 'IT', couleur: '#b053ad' },
  ...
  const eventTypes = {
    ...
    late: { label: 'Retard', color: '#faad14' },
    remote: { label: 'Télétravail', color: '#b053ad' },
    vacation: { label: 'Congés', color: '#722ed1' },
    sickness: { label: 'Maladie', color: '#fa541c' },
    training: { label: 'Formation', color: '#13c2c2' }
  };
  ...
  const formatEventTitle = (employeeId, type, allDay, start, end) => {
    ...
    if (allDay) {
      return `${employee.nom} - ${typeInfo.label}`;
    }
    
    return `${employee.nom} - ${typeInfo.label} (${moment(start).format('HH:mm')}-${moment(end).format('HH:mm')})`;
  };
            ...
            <Row gutter={8}>
              <Col span={8}>
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <div className="stat-value">{monthlyStats.present}</div>
                    <div className="stat-label">Presences</div>
                  </div>
                </div>
              </Col>
              <Col span={8}>
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <div className="stat-value">{monthlyStats.absent}</div>
              ...
              <Col span={8}>
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <div className="stat-value">{monthlyStats.vacation}</div>
                    <div className="stat-label">Conges</div>
                  </div>
                </div>
              </Col>
            </Row>
